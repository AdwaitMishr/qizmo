...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative pt-32 pb-20 px-4 md:pt-40 md:pb-32 overflow-hidden bg-gradient-to-r from-[#afaaff] to-[#f7ccff]"
    >
      <GlowingStars />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div style={{ opacity }} className="text-center md:text-left">
            ...
            <motion.p
              ...
              className="text-purple-900 mb-8 text-lg max-w-lg mx-auto md:mx-0"
            >
